...
var _subsubRoutine = require('../models/subsubRoutine');

var _subsubRoutine2 = _interopRequireDefault(_subsubRoutine);
...
function SubRoutineRoutes(app, express) {
    ...
    subRoutineRouter.route('/routines/:routine_id/subRoutines').post(function (req, res, next) {
        ...
        var subRoutine = new _subsubRoutine2.default();
        subRoutine.name = req.body.name;
        subRoutine.desiredFrequency = req.body.desiredFrequency;
    ...
    subRoutineRouter.route('/routines/:routine_id/subRoutines/:subRoutine_id').get(function (req, res, next) {
        _subsubRoutine2.default.findById(req.params.subRoutine_id, function (err, subRoutine) {
            if (!subRoutine) {
    ...
    .put(function (req, res, next) {
        _subsubRoutine2.default.findById(req.params.subRoutine_id, function (err, subRoutine) {
            ...
            if (req.body.modifiedDate) subRoutine.modifiedDate = req.body.modifiedDate;
        ...
        _subsubRoutine2.default.remove({
